...
MAX_CONTEXT_CHARACTERS_DEFAULT = 12_000
...
def _page_number(metadata: dict) -> int | None:
    """Convert zero-based page metadata into a display page number."""
...
def build_context(
    ...
    max_context_characters: int = MAX_CONTEXT_CHARACTERS_DEFAULT,
